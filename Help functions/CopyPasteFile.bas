...
Public Sub copyFile(sourceFolder As String, sourceFile As String, destFolder As String)
    Dim FSO As FileSystemObject
    Set FSO = CreateObject("Scripting.FileSystemObject")

    'Verify source file existency
    If Not FSO.FileExists(sourceFolder & sourceFile) Then
        MsgBox "Unable to find source file", vbOKOnly + vbExclamation, "Source file not found"
